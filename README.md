## Title  
Assessing Equitable Access to Green Space and Tree Canopy Cover in Calgary from the Perspective of Environmental and Human Health  
## Project Overview  
...
## Citation  
Garrido, H. (2025). *Green Space and Tree Canopy Cover in Calgary as an Indicator for Equity.* GitHub Repository.  
https://github.com/hailsgarr/Green-Space-and-Tree-Canopy-Equity  
## Acknowledgements  
Data from the City of Calgary Open Data Portal and Statistics Canada.  
Project completed for **GEOG 587 – University of Calgary.**  

## FAIR and CARE Principles  
This project aligns with **FAIR (Findable, Accessible, Interoperable, Reusable)** data principles  
and considers **CARE (Collective Benefit, Authority to Control, Responsibility, Ethics)** principles where relevant.  
